...
export const metadata: Metadata = {
  title: "Über uns | Ihre Digitalagentur INVERTA",
  description:
    "Lernen Sie INVERTA kennen. Wir sind Architekten des digitalen Raums - Strategie, Design und Entwicklung aus einer Hand.",
};

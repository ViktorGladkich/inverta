        ...
        <div className="flex flex-col gap-4 md:gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 h-auto md:h-[650px]">
            ...
            <Link
              ...
              className="group w-full md:w-[60%] h-auto md:h-full relative overflow-hidden rounded-[32px] md:rounded-[48px] bg-white p-8 md:p-12 flex flex-col justify-between transition-all duration-700 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] border border-black/5"
            >
            ...
            <div className="w-full md:w-[40%] flex flex-col gap-4 md:gap-6 h-auto md:h-full">
              ...
              <Link
                ...
                className="group w-full flex-1 relative overflow-hidden rounded-[32px] md:rounded-[48px] bg-black text-white p-8 md:p-10 border border-white/5 flex flex-col justify-between transition-all duration-700 hover:border-white/10 shadow-lg"
              >
                <article className="contents">
              ...
              <Link
                ...
                className="group w-full flex-1 relative overflow-hidden rounded-[32px] md:rounded-[48px] bg-white text-black p-8 md:p-10 flex flex-col justify-between transition-all duration-700 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.08)] border border-black/5"
              >
                <article className="contents">
                  <header className="flex justify-between items-start z-10 mb-16 md:mb-0">
                    <span className="px-5 py-2 rounded-full border border-black/10 text-xs font-bold tracking-widest uppercase bg-[#f5f5f5]">
          ...
          <Link
            ...
            className="group w-full h-auto md:h-[400px] relative overflow-hidden rounded-[32px] md:rounded-[48px] bg-[#daff02] text-black p-8 md:p-12 flex flex-col justify-between transition-all duration-700 shadow-sm hover:shadow-[0_20px_40px_-15px_rgba(218,255,2,0.4)]"
          >
            <article className="contents">

...
export function ServicesOverview() {
  ...
  return (
    <section
      id="services"
      className="relative z-10 bg-[#f5f5f5] py-12 md:py-16 px-4 md:px-8 overflow-hidden"
    >
      {/* Header der Leistungsübersicht */}
      <motion.div
      ...
      >
        ...
        {/* Haupttitel und SEO-Beschreibung */}
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-[#16101e]/80 font-normal leading-relaxed max-w-2xl mx-auto">
            ...
            kreatives <strong>Webdesign</strong> und strategisches{" "}
            <strong>Performance Marketing</strong> zu digitalen Erlebnissen, die
            Ihre Marke transformieren.
          </p>
        </div>
      </motion.div>

      {/* Grid für die einzelnen Service-Karten */}

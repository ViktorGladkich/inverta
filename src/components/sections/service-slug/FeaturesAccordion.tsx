      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="mb-24 md:mb-32">
          <motion.div
            ...
            className="flex flex-col items-center text-center gap-6 md:gap-8 mb-16"
          >
        ...
        <div className="flex flex-col border-t border-black/10">
          {features.map((feature, i) => (
            ...
            >
              <article className="group relative flex flex-col lg:flex-row justify-between py-12 md:py-20 border-b border-black/10 overflow-hidden cursor-default">
                ...
                <div className="relative z-10 lg:w-1/4 mb-6 lg:mb-0 flex items-start gap-4 pl-2 md:pl-4">
                  <span className="text-lg md:text-xl font-mono text-[#daff02] md:text-black/40 group-hover:text-white/50 transition-colors duration-500">
                    0{i + 1}
                  </span>
